...
function Banner() {
  return (
    <div className="flex flex-col md:flex-row justify-between shadow-xl items-center bg-white px-4 sm:px-8 md:px-16 py-10 md:h-60 max-w-6xl w-full m-auto rounded-3xl gap-6">
      
      {/* Heading */}
      <div className="text-center md:text-left">
        <h1 className="text-lg sm:text-xl md:text-3xl font-bold max-w-lg text-center leading-snug">
